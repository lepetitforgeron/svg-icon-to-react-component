const expected = [
  ...
  `  return (<svg height="24" width="24" version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>` +
...
module.exports = (actual) => {
  console.assert(
    ...
    `svg-icon-to-react-component-loader should return stateless functional react component` +
    `\n\n==> Actual result:\n${actual}` +
    `\n\n==> Expected result:\n${expected}`
  );
